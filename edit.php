...
<header class="w3-container w3-theme-d3 w3-padding-16">
  <h6><a href=index.php>#</a> | REGISTER TO STUDENT DETAILS :</h6>
</header>
<div class=w3-container>

<table>
<tr><form name="myform" action="save.php" method="post" onsubmit="myAccFunc('loading')">
</tr>
<tr>
...
<tr style='display:none;' id='I'><td>I SEM</td><td><input class="other" type="number" name="I" step="0.01"></td></tr>
