...
if($fm1<35 || $fm2 < 35 || $fm3 <35 || $fm4<35|| $fm5<35 || $fm6<35 || $fm6<18|| $fm7<18|| $fm8<18)
$class="FAIL";
elseif($per>=69.2)
...
<tr><td><font color='.$fm1c.'>ENGINEERING MATHS I/II</font></td><td>'.$fim1.'</td><td>'.$fm1.'</td><td>'.$ftm1.'</td></tr>
<tr><td><font color='.$fm2c.'>ENGINEERING CHEMISTRY</font></td><td>'.$fim2.'</td><td>'.$fm2.'</td><td>'.$ftm2.'</td></tr>
<tr><td><font color='.$fm3c.'>COMPUTER CONCEPTS &AMP; C PROG</font></td><td>'.$fim3.'</td><td>'.$fm3.'</td><td>'.$ftm3.'</td></tr>
<tr><td><font color='.$fm4c.'>COMPUTER AIDED ENGINEERING DRAWING</font></td><td>'.$fim4.'</td><td>'.$fm4.'</td><td>'.$ftm4.'</td></tr>
<tr><td><font color='.$fm5c.'>BASIC ELECTRONICS</font></td><td>'.$fim5.'</td><td>'.$fm5.'</td><td>'.$ftm5.'</td></tr>
<tr><td><font color='.$fm6c.'>COMPUTER PROGRAMMINB LAB</font></td><td>'.$fim6.'</td><td>'.$fm6.'</td><td>'.$ftm6.'</td></tr>
<tr><td><font color='.$fm7c.'>ENGINEERING CHEMISTRY LAB</font></td><td>'.$fim7.'</td><td>'.$fm7.'</td><td>'.$ftm7.'</td></tr>
<tr><td><font color='.$fm8c.'>ENVIRONMENTAL STUDIES</font></td><td>'.$fim8.'</td><td>'.$fm8.'</td><td>'.$ftm8.'</td></tr>
...
$file = fopen("IISEMMARKS/$IISEM", "w");
fwrite($file,$t_data);
fclose($file);

echo 'Form data has been saved to '.$tfname.'  <br>
<a href="IISEMMARKS/'.$IISEM.'">Click here to read </a> ';
?>
